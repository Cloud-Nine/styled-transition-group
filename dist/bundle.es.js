...
function parseCss(strings) {
  ...
  return css.apply(undefined, [next.strings].concat(toConsumableArray(next.interpolations)));
}
...
var construct = (function (animated, Tag, config) {
  return extend(animated, styled(Tag), config);
});
    ...
    return _temp = _class = function (_Component) {
      ...
      createClass(_class, [{
        ...
        value: function renderTarget(props) {
          return React.createElement(Target, _extends({ transitionClassNames: this.constructor.classNames }, props));
        }
      }, {
        key: "renderChildren",
      ...
      return _class;
    }(Component), _class.Target = Target, _class.displayName = "Animated(" + Target.displayName + ")", _class.styledComponentId = Target.styledComponentId, _class.attrs = attrs, _temp;
  };
};
...
var index = styled(animated, construct);

export default index;
export { parseCss as css };
